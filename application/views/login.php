...
<head>
	<title>Login SI Inventaris Fisika</title>
	<meta charset="utf-8">
			...
			<div class="vertical-align-middle">
				<div class="auth-box">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><img src="<?=base_url()?>/assets/logo.png" >
									<h1>Sistem Informasi Inventaris</h1>
							<p>Laboratorium Fisika SMAN 6 Bengkulu</p></div>
								
							</div>
							<form class="form-auth-small" action="<?=base_url('login/login_action')?>" method="post">
