										...
										<tbody>
											<?php $no=0; foreach ($data as $isi) {
												...
												<tr>
                                                    ...
                                                    <td>
                                                    <?php if($isi['status'] == 'Menunggu'){ ?>
                                                    <a  style="margin-top:5px" href="<?=base_url('laboran/setuju_bahan/'.$isi['id_pinjam'])?>" class="btn btn-success btn-sm"><i>Setuju</i></a>
													<a  style="margin-top:5px" href="<?=base_url('laboran/tolak_bahan/'.$isi['id_pinjam'])?>" class="btn btn-danger btn-sm"><i>Tolak</i></a>
                                                    <?php }else{ ?>
                                                    <?php echo $isi['status']; }?>
                                                    </td>
												</tr>
							...
							buttons:[
								{
									title:'',
						 			...
						 			customize: function(win){
                                        ...
                                        $(win.document.body).find('table td:nth-child(9)').css('text-align','center');
