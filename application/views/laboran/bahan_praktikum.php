											...
											<?php $no=0; foreach ($datanya as $isi) {
												...
												<tr>
													...
													<td>
														<a
															href="javascript:;"
															data-id_bahan="<?php echo $isi['id_bahan'] ?>"
															data-nama_bahan="<?php echo $isi['nama_bahan'] ?>"
														...
														<a href="<?=base_url('Laboran/bahan_praktikum_hapus/'.$isi['id_bahan'])?>"><button onclick="return confirm('Hapus ?');" type="button" class="btn btn-danger"><i class="lnr lnr-trash"></i> Hapus</button></a>
													</td>	
												</tr>
											<?php } ?>
										</tbody>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form action="<?=base_url('Laboran/bahan_praktikum_tambah_update')?>" method="post">
													<h3 class="panel-title">Nama Bahan</h3>
													<br>
													<input type="text" name="nama" class="form-control" placeholder="Nama Bahan">
													<br>
													<div class="row">
														<div class="col-md-6">
													...
													<br>
													<select class="form-control" name="rak" id="raks">
														<option value="" disabled selected hidden>Pilih Rak</option>
													</select>
													<br>
													<h3 class="panel-title">Tahun Pengadaan</h3>
													<br>
													<input type="number" name="tahun" list="inputtahun" class="form-control" placeholder="Tahun Pengadaan" min="2000">
													<br>
								...
								<div id="ModalUbah" class="modal fade" role="dialog">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form action="<?=base_url('Laboran/bahan_praktikum_ubah_update')?>" method="post">
													<input type="hidden" id="idku" name="id">
													<h3 class="panel-title">Nama Bahan</h3>
													<br>
													<input type="text" name="namax" id="namaku" class="form-control" placeholder="Nama Bahan">
													<br>
													<div class="row">
														<div class="col-md-6">
													<h3 class="panel-title">Jumlah</h3>
													<br>
													<input type="number" list="inputjumlah" name="jumlahx" id="jumlahku" class="form-control" placeholder="Jumlah">
														</div>
														<div class="col-md-6">
													<h3 class="panel-title">Satuan</h3>
													<br>
													<select class="form-control" name="satuanx" id="satuanku">
														<option value="gram">Gram</option>
														<option value="mililiter">Mililiter</option>
													</select>
														</div>
													...
													<br>
													<h3 class="panel-title" onchange="f2xx()">Nama Rak</h3>
													<br>
													<select class="form-control" name="rakx" id="rakku">
													</select>
													<br>
													<h3 class="panel-title">Tahun Pengadaan</h3>
													<br>
													<input type="number" name="tahunx" list="inputtahun" id="tahunku" class="form-control" placeholder="Tahun Pengadaan" min="2000">
													<br>
