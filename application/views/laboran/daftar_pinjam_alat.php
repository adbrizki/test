										...
										<tbody>
											<?php $no=0; foreach ($data as $isi) {
												...
												<tr>
													...
													<a  style="margin-top:5px" href="<?=base_url('laboran/setuju/'.$isi['id_pinjam'])?>" class="btn btn-success btn-sm"><i>Setuju</i></a>
													<a  style="margin-top:5px" href="<?=base_url('laboran/tolak/'.$isi['id_pinjam'])?>" class="btn btn-danger btn-sm"><i>Tolak</i></a>
                                                    <?php }else{ ?>
													<?php echo $isi['status']; }?>	
													</td>
												</tr>
