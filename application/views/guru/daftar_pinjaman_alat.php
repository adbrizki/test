<div class="main-content">
				<div class="container-fluid">
					<h3 class="page-title">Daftar Pinjaman Alat Praktikum</h3>
									...
									<table class="table table-hover" id="tabel">
										<thead>
											<tr>
												...
												<th>Nama Alat</th>
												<th>Status</th>
												<th>Jumlah Alat Dipinjam</th>
												<th>Opsi</th>
											</tr>
										</thead>
										<tbody>
											<?php $no=0; 
											$result=$this->db->query("SELECT daftar_alat_praktikum.id_alat,daftar_alat_praktikum.nama_alat,daftar_alat_praktikum.jumlah,daftar_alat_praktikum.jumlah_baik,daftar_alat_praktikum.jumlah_rusak_ringan,daftar_alat_praktikum.jumlah_rusak_berat,
											 peminjaman_alat.id_pinjam,peminjaman_alat.id_alat,peminjaman_alat.status,peminjaman_alat.jumlah_pinjam
											 FROM peminjaman_alat join daftar_alat_praktikum on peminjaman_alat.id_alat=daftar_alat_praktikum.id_alat ORDER BY daftar_alat_praktikum.id_alat ASC")->result_array();
