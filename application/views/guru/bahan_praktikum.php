						...
						<div class="col-md-13">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<button onclick="window.location.href='<?=base_url('Guru/daftar_peminjaman_bahan')?>'" type="button" class="btn btn-primary"><i class="" id="ikon"></i>Daftar Peminjaman Bahan</button>
							...
							<div id="Pinjam" class="modal fade" role="dialog">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form action="<?=base_url('Guru/mulai_pinjam_bahan/'.$isi['id_bahan'])?>" method="post">
