						...
						<div class="col-md-13">
							...
							<div class="panel">
								...
								<div class="panel-body">
									...
									<button onclick="window.location.href='<?=base_url('Guru/daftar_peminjaman_alat')?>'" type="button" class="btn btn-primary">Daftar Peminjaman Alat</button>
										...
										<tbody>
											...
											foreach ($datanya as $isi) {
												...
												<tr>
													...
													<td>
														<?php if($isi['jumlah']>0 && $isi['jumlah_baik']>0){
													echo'<button data-toggle="modal" data-target="#Pinjam" style="margin-top:5px" class="btn btn-success btn-sm"><i class="lnr lnr-hand">Pinjam</i></button>';
															}else{
							...
							<div id="Pinjam" class="modal fade" role="dialog">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form action="<?=base_url('Guru/mulai_pinjam_alat/'.$isi['id_alat'])?>" method="post">
