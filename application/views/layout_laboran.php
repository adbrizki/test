					...
					<ul class="nav">
						<li>
							...
							<div id="barang" class="collapse ">
								<ul class="nav">
									<li><a href="<?=base_url('Laboran/alat_praktikum_laboran')?>" class="">Alat Praktikum</a></li>
									<li><a href="<?=base_url('Laboran/bahan_praktikum_laboran')?>" class="">Bahan Praktikum</a></li>
									
								</ul>
							</div>
						</li>
						<li>
							<a href="#lemari" data-toggle="collapse" class="collapsed"><i class="lnr lnr-database"></i> <span>Lemari & Rak</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="lemari" class="collapse ">
								<ul class="nav">
									<li><a href="<?=base_url('Laboran/rak_laboran')?>" class="">Daftar Rak</a></li>
									<li><a href="<?=base_url('Laboran/lemari_laboran')?>" class="">Daftar Lemari</a></li>
								</ul>
							</div>
						</li>
						...
						<li>
							...
							<div id="peminjaman" class="collapse ">
								<ul class="nav">
									<li><a href="<?=base_url('laboran/pinjam_alat')?>" class="">Alat</a></li>
									<li><a href="<?=base_url('laboran/pinjam_bahan')?>" class="">Bahan</a></li>
								</ul>
							</div>
						</li>
					
						<li><a href="<?=base_url('Laboran/logout')?>"><i class="fa fa-sign-out"></i> <span>Keluar</span></a></li>
					</ul>
				</nav>
			</div>
		</div>
